...
| 72 (Claude branch) | SKIP-COST proved (E^1/E^2 are the only orbit-preserving generators; every E^2 is an R costing Ndef+1) and combined with a LIVE-PORT SUPPLY bound; closes 114,298 of the 292,198 capacity_slack survivors, residual 200,408 -> **177,900** in 945 classes. Closure of the tight band **refuted**: E^2 is never locally forced | this branch, `research/RR_SKIP_COST_THEOREM_CLAUDE.md` |
