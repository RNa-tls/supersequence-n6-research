...
if __name__=='__main__':
    ...
    p.add_argument('--resource-guard',action='store_true');a=p.parse_args()
    ...
    wrapper='r171/src/run_bulk_resource_guard_j171.py' if a.resource_guard else 'r171/src/run_bulk_escalation_j171.py'
    command=[sys.executable,'-u',wrapper,'--cap',str(a.cap),'--workers',str(a.workers)]
