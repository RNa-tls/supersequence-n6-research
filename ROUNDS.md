...
| | |
|---|---|
| Proof-valid Q2 / Area-A residual | **6,657** states *(independent count audit pending)* |
| Canonical residual classes | **761** |
| Roots with empty Q2 residual | **28 / 33** (every long root clear) |
| Q2-admissible frontier (Round 71) | 3,248,890 |
| Last round | **80** — Round-79 audit archive exported; counts replay from the artifact alone |
