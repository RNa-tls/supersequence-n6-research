...
| | |
|---|---|
| Proof-valid Q2 / Area-A residual | **6,582** states *(6,657 audited baseline − 13 in Round 85 − 62 in Round 90)* |
...
| Last round | **90** — single short pass theorem: the ℓ<5 budget is **1 or 0**, not 2; **62 closed**, all 19 unique-cover states among them |
