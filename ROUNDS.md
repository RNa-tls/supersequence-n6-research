...
| Last round | **92** — fragment-local short opportunity replaces the generic exception: **186 closed**, 0 UNKNOWN; survivors need no short edge at all, so the short-edge family is exhausted |
