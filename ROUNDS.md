...
| | |
|---|---|
| Proof-valid Q2 / Area-A residual | **6,586** states *(6,657 audited baseline − 13 in Round 85 − 58 in Round 90, **Codex-audited**)* |
...
| Last round | **91-A** — boundary-witness autopsy: closure **0**; Round-90 ledger corrected to **58 / 6,586**; candidate constraint **SHORT-PASS LOCALITY** extracted, pending Codex audit |
